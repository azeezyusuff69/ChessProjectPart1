...
Search
Sign in or Sign up
 Watch 1  Star 0  Fork 0 Virksaabnavjot/AI
 Code  Issues 0  Pull requests 0  Projects 0  Insights
Branch: master Find file Copy pathAI/AI/src/atom/Chess/ChessProject.java
3a8dcad  on Dec 15, 2016
@Virksaabnavjot Virksaabnavjot Working Project Atom and Netbeans both
1 contributor
RawBlameHistory
Executable File  1675 lines (1568 sloc)  78.5 KB
...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
  ...
  Method to find all the White Pieces.
    ...
    //When the AI Agent decides on a move, a red border shows the square from where the move started and the landing square of the move.
...
//      out to the standard output.
            ...
            if (l instanceof JLabel) {
                ...
                //if CPU pawn makes it across the board promote him to white queen on a capture move
                ...
                //if CPU makes it across the board to an empty square, make him queen
            ...
            is nothing in its way. It can take an opponents piece and as you know it cannot take its own piece.
              ...
              that its not our own piece...
                 ...
                 */ if (xMovement == yMovement) {
                    ...
                    else //we have movement along the y axis
                    {
                        if (startY - landingY > 0) {
                            //movement in the left direction....
                            for (int i = 0; i < yMovement; i++) {
